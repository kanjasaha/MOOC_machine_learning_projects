...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.5):
        ...
        random.seed(14851)
        self.t = 0 # trial number. epsilon score with change with this t value.
    ...
    def reset(self, destination=None, testing=True):
        ...
        if testing:
            ...
            #self.epsilon = self.epsilon - 0.05  # decaying value of epsilon. for question 6
            self.epsilon *= math.e**(-0.00124)
            self.alpha=.7
            self.tolerance=.01
    ...
    def build_state(self):
        ...
        # tuple consist of 5 feature. we are ignoring deadline for the time being as per my answer in Q4 and 5
    ...
    def get_maxQ(self, state):
        ...
        q_value = [ self.Q[state].get((key), 0.0) for key in self.Q[state]] # get all the values for all actions for this state
        maxQ = max(q_value)
