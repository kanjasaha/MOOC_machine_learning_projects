...
class Task_TakeOff():
    ...
    def __init__(self, init_pose=None, init_velocities=None,
        ...
        ======
            ...
            target_z: target/goal (height) position for the agent
        """
        # Simulation
         # Simulation
...
#         init_angle_velocities = np.array([0., 0., 0.])   # initial angle velocities
        ...
        # Goal
        #self.target_z = target_z if target_z is not None else 20
...
#         penalty += abs(current_position[0]-0)**2
#         penalty += abs(current_position[1]-0)**2
#         penalty += abs(current_position[2]-self.target_z)**2
...
#         v_distance = np.sqrt((current_position[2]-self.target_z)**2)
#         if distance < 10:
#             reward += 1000
