...
#         print('physics init lower bound upper bound')
...
#         print(position)
        ...
        new_positions = []
        for ii in range(3):
#             print('physics next_timestep position[ii] x y z')
#             print(ii)
#             print(position[ii] )
#             print('=======')
